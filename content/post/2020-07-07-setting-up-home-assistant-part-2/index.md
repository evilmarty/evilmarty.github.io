...
{{< alert color="info" >}}
Please read [Part 1]({{< ref "post/2020-05-20-setting-up-home-assistant-part-1.md" >}}) of my guide if you haven't yet done so.
{{< /alert >}}
...
{{< image src="home-assistant-ipmi-entities.jpg" alt="IPMI Sensors in Home Assistant" >}}
...
{{< image src="home-assistant-addon-store.jpg" alt="The Add-on Store" >}}
