...
behemoth of a home server with a much smaller and almost unnoticeable Intel NUC.
...
night and triggers a reboot. My last criticism is that it's very cumbersome.
...
{{< image src="intel-nuc.png" alt="Intel NUC" >}}

I'm not going to explain why you should or should not purchase an Intel NUC.
Suffice to say, it was cheap and intriguing and, more importantly, [Home
...
me a nice and simple GUI to run their Disk Partitioning application to allow me
...
[2]: {{< ref "post/2020-05-20-setting-up-home-assistant-part-1.md" >}}
