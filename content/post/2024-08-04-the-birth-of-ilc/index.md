...
Other people may also find these scripts useful which just adds to the complexity and commitment required to writing a good script. Sometimes I find the effort isn't worth it and just accept it's a quick and basic script. By the way, there is nothing wrong with this approach. Having something usable is better than not having anything at all and as it gains more usage we may invest more time to enhancing it. Overall, there are many approaches one can take.
